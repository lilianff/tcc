...
// home page JS
if (pageTitle.text === "Tudo para o sim  - ") {
...
// Função para lidar com o clique nos links protegidos
...
// Adicionar evento aos links protegidos quando o documento for carregado
document.addEventListener("DOMContentLoaded", function () {
  const protectedLinks = document.querySelectorAll("a[data-redirect='true']");
